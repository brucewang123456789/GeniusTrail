...
wlog=ROOT/'certificates'/'strict'/'wells_v2.log'
if wlog.exists():
...
alog=ROOT/'certificates'/'strict'/'audit_constants.log'
if alog.exists():
...
for name,s,e in expected:
    choices=[ROOT/'certificates'/'strict'/f'{name}_final.log',ROOT/'certificates'/'strict'/f'{name}_bb26.log',ROOT/'certificates'/'strict'/f'{name}.log']
